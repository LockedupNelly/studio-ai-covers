...
import { Disc3, Sparkles, LogOut, ShoppingCart, Home, Coins } from "lucide-react";
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <Button variant="ghost" size="icon" onClick={signOut} className="text-foreground/70 hover:text-foreground">
