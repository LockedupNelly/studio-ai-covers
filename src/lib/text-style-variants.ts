...
const DARK_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  7: "TYPOGRAPHY STYLE: EXTREME DEATH METAL / BLACK METAL typography with SHARP SPIKY EXTENSIONS radiating from letters. LETTERFORMS: Aggressive uppercase letters with MANY SHARP POINTED SPIKES and thorny extensions shooting outward from the letterforms in all directions. The letters themselves are angular and jagged with intentionally rough, uneven edges. CRITICAL SPIKE STYLE: ABUNDANT sharp pointed spikes, thorns, and blade-like extensions radiate OUT from the letters - extending upward, downward, and diagonally. These are NOT subtle - they are dramatic, long, sharp protrusions that make the text look dangerous and weaponized. Some spikes cross over between letters. The overall silhouette is chaotic and spiky like a thorny mass or barbed wire. LETTERFORM CONSTRUCTION: Letters are constructed with angular, jagged strokes. Vertical strokes may have rough/torn edges. Letters like 'O', 'G', 'S' have aggressive pointed forms rather than curves. The 'T', 'I', 'L' have multiple spike extensions. Every letter has several sharp protrusions extending from it. TEXTURE: Solid white with possible subtle worn or rough texture. The spikes are clean and sharp. NO glitch effects, NO digital distortion, NO scan lines. COLOR: Pure white spiky text on pure black background. High contrast, clean but chaotic. MOOD: Extreme death metal, black metal band logos, brutal and aggressive. The text should look DANGEROUS with abundant sharp thorny spikes radiating from every letter.",
