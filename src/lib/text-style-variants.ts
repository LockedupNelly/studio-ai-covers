...
const CREATIVE_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  4: "TYPOGRAPHY STYLE: ULTRA TALL condensed BOLD SANS-SERIF with WAVY SLANTED distortion. CRITICAL - MUST BE SANS-SERIF: Absolutely NO serifs, NO decorative elements - clean geometric sans-serif letterforms only (like Impact, Bebas, or condensed Helvetica). LETTERFORMS: Extremely tall and narrow uppercase letters, VERY heavy bold weight, letters touching or nearly touching (extremely tight letter spacing). CRITICAL WAVY EFFECT: The letters have a pronounced WAVE/SLANT distortion - they curve and lean dynamically as if bending in wind or viewed through water. The vertical strokes of letters curve slightly inward/outward creating an organic wave pattern across the word. Letters appear to tilt and sway. NOT just slightly wobbly - clearly visible wave distortion throughout. EFFECTS: Dynamic wave/slant distortion, letters leaning at varying angles, organic flow across the text. COLOR: Pure white text on solid black background. MOOD: Bold impactful headlines, modern poster design, commanding presence with dynamic wavy energy.",
  
  5: "TYPOGRAPHY STYLE: BOLD SANS-SERIF with CRACKED/SHATTERED texture throughout letters. CRITICAL - MUST BE SANS-SERIF: Heavy bold geometric sans-serif letterforms (like Impact or Bebas Neue), NO serifs, NO neon, NO glow effects. LETTERFORMS: Thick, bold, uppercase sans-serif letters with strong presence. CRITICAL CRACKED EFFECT: The letters MUST have visible CRACKS, BREAKS, and FRACTURES running through them - like cracked concrete, shattered glass, or broken stone. White/light colored cracks and fissures cut through the dark letters creating a damaged/weathered appearance. The cracks should be irregular lines that split and branch across the letterforms. TEXTURE: Grungy, distressed, cracked surface texture. NOT smooth - visibly fractured and broken. COLOR: White or off-white text with dark cracks/breaks visible throughout, on dark background. MOOD: Rugged, weathered, broken, street art, grunge poster aesthetic. NO NEON, NO GLOW, NO OUTLINES.",
