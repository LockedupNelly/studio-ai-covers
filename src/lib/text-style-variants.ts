...
const CREATIVE_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  5: "TYPOGRAPHY STYLE: HEAVILY DISTRESSED GRUNGE SANS-SERIF with MAJOR TRANSPARENT CRACK. CRITICAL - MUST BE SANS-SERIF: Heavy bold geometric sans-serif letterforms (like Impact or Bebas Neue), NO serifs, NO neon, NO glow. LETTERFORMS: Thick, bold, uppercase letters with HEAVILY WORN, ROUGH, BROKEN EDGES - letters should look severely weathered and damaged. CRITICAL DISTRESSED TEXTURE: The letters MUST have INTENSE grunge distressing - rough eroded edges, chunks missing, scratched and worn surface texture, paint peeling effect, heavily weathered concrete/stone appearance. The text should look like it survived a war - beaten, broken, aged. CRITICAL TRANSPARENT CRACK: ONE LARGE DIAGONAL CRACK/SPLIT running through the entire text showing the background through it - a transparent gap in the letters. TEXTURE: Extremely rough, gritty, concrete-like with visible damage, erosion, and decay throughout. Edges should be jagged and broken, not smooth. COLOR: Off-white/cream weathered text with dark grime and damage marks on dark background. MOOD: Post-apocalyptic, destroyed, heavily weathered street poster, maximum grunge. NO NEON, NO GLOW, NO CLEAN EDGES.",
  ...
  7: "TYPOGRAPHY STYLE: BLURRED GLOWING TEXT with WAVY MELTING BOTTOM. LETTERFORMS: Bold, heavy sans-serif uppercase letters with an overall soft blur/glow effect. CRITICAL WAVY MELTING EFFECT: The BOTTOM THIRD of each letter MUST appear to be MELTING and WAVY - not straight vertical drips, but WAVY, LIQUIFIED, DISTORTED melting effect. The bottom of the letters warps, waves, and drips downward in an organic liquid fashion - like wax melting or paint running with wavy distortion. The melting portions should have irregular wavy edges and blur as they extend downward. CRITICAL BLUR: The entire text has a soft glow/blur quality, with the bottom melting portions being even more blurred and wavy. EFFECTS: Overall soft glow, wavy/liquified distortion on bottom third, organic melting drips with wavy irregular edges, letters appearing to dissolve and melt downward. COLOR: White or light colored text with soft glow on dark background. MOOD: Dreamlike, ethereal, melting/dissolving, liquid distortion aesthetic. The wavy melting effect is KEY - not straight drips.",
  
  8: "TYPOGRAPHY STYLE: STYLIZED GOTHIC SERIF with DRAMATIC SMOKE/FLAME WISPS rising from top. LETTERFORMS: Elegant gothic-style serif font with subtle pointed serifs (NOT Times New Roman - more stylized/decorative gothic serif), readable but with character. CRITICAL FLAME/SMOKE EFFECT: The TOP of each letter MUST have DRAMATIC tall smoke/flame wisps rising FAR UPWARD - these are blurred, wispy, smoke-like tendrils that extend significantly above the letters (at least half the letter height above). The wisps should blur and fade as they rise, creating an ethereal dissolving effect. BOTTOM of letters stays SOLID and readable, TOP dissolves into dramatic tall smoke wisps. CRITICAL COLOR: Flames/smoke should be WHITE or GRAY - like smoke or ghostly flames, NOT orange fire. The effect is ethereal smoke rising, not literal fire. EFFECTS: Tall dramatic wispy smoke tendrils, heavy blur/fade on the rising wisps, ghostly ethereal quality, letters appearing to emit smoke upward. MOOD: Haunting, ethereal, ghostly, dramatic smoke/mist rising effect. The smoke wisps must be TALL and DRAMATIC, not subtle.",
