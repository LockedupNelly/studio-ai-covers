...
const CREATIVE_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  4: "TYPOGRAPHY STYLE: ULTRA TALL condensed bold sans-serif with subtle WAVY/DISTORTED warping. LETTERFORMS: Extremely tall and narrow uppercase letters (very high aspect ratio - letters are stretched vertically), heavy bold weight, tightly spaced. CRITICAL EFFECT - WAVY DISTORTION: The letters have a slight organic wave/wobble distortion - they're not perfectly straight but have subtle curves and warping as if viewed through heat distortion or liquid. The baseline and edges of letters gently undulate. EFFECTS: Subtle wave distortion throughout letterforms, slight perspective warping, organic imperfections in otherwise geometric letters. COLOR: Pure white text on solid black background. MOOD: Bold impactful headlines, modern poster design, commanding presence with organic energy.",
