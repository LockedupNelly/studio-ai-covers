...
const CREATIVE_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  8: "TYPOGRAPHY STYLE: GOTHIC SERIF with TOP COMPLETELY BLOWN OUT INTO FADING MIST. LETTERFORMS: Elegant gothic-style serif font with subtle pointed serifs (NOT Times New Roman). CRITICAL BLOWN OUT EFFECT: The TOP PORTION of each letter MUST be COMPLETELY BLOWN OUT - fading into extremely blurry, warped, dispersing mist that looks like it is being blown away by wind. The top of the letters should DISSOLVE and FADE into soft, wispy, blurred smoke/mist that extends far above the text and gets increasingly transparent and faded. This is NOT defined flames - it is blown out, fading, dispersing mist. The effect should feel like the letters are evaporating or being blown apart at the top. BOTTOM of letters stays more solid and readable, but even the middle transitions into blur. The mist should be EXTREMELY BLURRY and FADED - almost disappearing into nothing. COLOR: White, gray, or any color that matches the cover vibe - the mist fades from solid color to transparent blur. MOOD: Ethereal, vanishing, blown away, fading into mist, dreamlike dissolution. The blown out fading effect must be DRAMATIC and OBVIOUS.",
