...
const CREATIVE_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  7: "TYPOGRAPHY STYLE: COMPLETELY BLURRY TEXT with CHAOTIC MELTING BOTTOM that FADES INTO NOTHING. LETTERFORMS: Bold uppercase letters that are BLURRY AND SOFT THROUGHOUT - no sharp edges anywhere. The ENTIRE text has an out-of-focus, glowing quality. CRITICAL CHAOTIC MELTING: The BOTTOM of each letter MUST melt CHAOTICALLY - not neat structured drips, but MESSY, IRREGULAR, WARPED melting that looks like the letters are dissolving and fading away into nothing. The melting portions should be EXTREMELY BLURRY, chaotically warped, and FADE to transparency - disappearing into the background. This is NOT clean dripping - it is chaotic dissolution, warped and distorted as it fades out. CRITICAL BLUR: Everything must be soft and blurry - the text glows softly, and the melting bottom portions are even more blurred and faded, eventually becoming transparent and disappearing. NO STRUCTURED DRIPS - only chaotic, messy, warped melting that fades into nothingness. COLOR: White or light colored glowing text on dark background. MOOD: Dreamlike, dissolving, fading away, chaotic liquid melting into void.",
