...
const CREATIVE_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  7: "TYPOGRAPHY STYLE: BLURRED DRIPPING/LEAKING TEXT with bottom half dissolving downward. LETTERFORMS: Bold, heavy sans-serif uppercase letters. CRITICAL BLUR/DRIP EFFECT: The TOP HALF of each letter is relatively SHARP and CLEAR, but the BOTTOM HALF of every letter MUST be BLURRED and DRIPPING/LEAKING DOWNWARD - like the text is melting, running, or dissolving from the bottom. The blur should create vertical streaks extending below the letters as if the paint/ink is dripping down. The text looks like it's made of wet paint or liquid slowly running down. EFFECTS: Vertical motion blur on bottom portions, downward dripping/streaking, dissolving edges at bottom, wet/liquid appearance. COLOR: White or light colored text with blur/drip effects on dark background. MOOD: Melting, dissolving, ethereal, dreamy dissolution, wet paint aesthetic. NO 3D EXTRUSION, NO HARD SHADOWS.",
