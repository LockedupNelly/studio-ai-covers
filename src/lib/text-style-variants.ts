...
const DARK_VARIANT_DESCRIPTIONS: Record<number, string> = {
  ...
  6: "TYPOGRAPHY STYLE: AGGRESSIVE BRUSH STROKE / SLASHING typography with dynamic angular energy. LETTERFORMS: Bold, dramatic uppercase letters that look PAINTED with aggressive, fast brush strokes. Letters are ITALICIZED/SLANTED at a strong forward angle. The strokes have DYNAMIC MOVEMENT with sharp pointed flicks and aggressive terminals that look like quick brush swipes or paint slashes. CRITICAL BRUSH STROKE QUALITY: Each letter has an energetic, hand-painted feel with visible brush dynamics - thick confident strokes with sharp tapered ends that flick outward. The letters have SPEED and MOTION built into their forms, like they were painted with aggressive slashing movements. ANGULAR SLANT: Strong italic/forward lean creating sense of speed and aggression. Letters look like they're in motion, rushing forward. STROKE STYLE: Bold thick strokes with dramatic tapered points at terminals. Sharp angular cuts where strokes end. The 'O' and 'T' and other letters have aggressive pointed flourishes extending from them. Some strokes extend past the letter body as dynamic slashes or flicks. TEXTURE: Solid white with subtle brush texture or clean and bold. NO paper texture, NO cracking, NO weathering. Clean, graphic, dynamic. COLOR: Pure white or off-white text on pure black background. High contrast, clean and punchy. MOOD: Aggressive rock/metal logo, action movie titles, dynamic sports branding. Fast, powerful, in-your-face energy with brush stroke dynamism.",
